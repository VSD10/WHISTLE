        ...
        <>
            ...
            {showTerms && (
                <div className="fixed inset-0 z-[200] bg-black/90 backdrop-blur-sm flex items-center justify-center p-4 animate-fade-in">
                    <div className="w-full max-w-2xl bg-deep-black border border-neon-green/30 shadow-[0_0_50px_rgba(57,255,20,0.2)] max-h-[80vh] flex flex-col">
                        <div className="p-6 border-b border-white/10 bg-neon-green/5">
                        ...
                        <div className="flex-1 overflow-y-auto p-6 space-y-4 text-sm text-white/80 font-mono">
                            ...
                            <p className="text-neon-green font-bold mt-4">4. USER RESPONSIBILITIES</p>
                            <p>You are responsible for maintaining the confidentiality of your account and password. You agree to accept responsibility for all activities that occur under your account.</p>

                            <p className="text-neon-green font-bold mt-4">5. PROHIBITED USES</p>
                            <p>You may not use WHISTLE for any illegal or unauthorized purpose. You must not violate any laws in your jurisdiction.</p>

                            <p className="text-neon-green font-bold mt-4">6. DISCLAIMER</p>
                        ...
                        <div className="p-6 border-t border-white/10 bg-white/5">
                            ...
                            <div className="flex gap-4">
                                ...
                                <button
                                    ...
                                    className="flex-1 bg-neon-green text-black px-6 py-3 text-xs font-bold tracking-widest hover:bg-white transition-all uppercase disabled:opacity-50 disabled:cursor-not-allowed"
                                >
                                    Accept & Continue
                                </button>
                            </div>
