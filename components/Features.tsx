  ...
  return (
    <section className="py-40 container mx-auto px-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
        <div className="border border-neon-green p-10 relative overflow-hidden group hover:bg-neon-green/5 transition-colors">
        ...
        <div className="border border-white/20 p-10 relative overflow-hidden hover:border-neon-magenta transition-colors group">
        ...
        <div className="border border-white/20 p-10 relative overflow-hidden hover:border-neon-green transition-colors group">
