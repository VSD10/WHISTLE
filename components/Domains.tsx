...
const Domains: React.FC = () => {
  return (
    <section className="py-40 bg-data-gray overflow-hidden">
      <div className="container mx-auto px-6">
        <h2 className="text-5xl font-header font-black uppercase mb-16 tracking-tighter">Deployed_Domains</h2>
        <div className="flex flex-wrap gap-4">
          <div className="bg-white text-black p-8 flex-1 min-w-[250px] skew-x-[-6deg] hover:bg-neon-green transition-colors cursor-default group">
          ...
          <div className="border border-neon-magenta p-8 flex-1 min-w-[250px] skew-x-[6deg] hover:bg-neon-magenta hover:text-black transition-colors group cursor-default">
          ...
          <div className="bg-neon-green text-black p-8 flex-1 min-w-[250px] skew-x-[-6deg] hover:bg-white transition-colors cursor-default group">
          ...
          <div className="border border-white/20 p-8 flex-1 min-w-[250px] skew-x-[6deg] hover:border-neon-green hover:bg-neon-green/10 transition-colors cursor-default group">
