      ...
      <div className="container mx-auto px-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-px bg-white/5">
          ...
          <div className="bg-deep-black p-8 border-r border-white/5 group hover:bg-neon-green/5 transition-colors">
            ...
            <h4 className="text-xl font-header font-black uppercase mb-4 tracking-tighter">Ingestion</h4>
          ...
          <div className="bg-deep-black p-8 border-r border-white/5 group hover:bg-neon-green/5 transition-colors">
            ...
            <h4 className="text-xl font-header font-black uppercase mb-4 tracking-tighter">Multi-Agent Split</h4>
            <p className="text-[10px] text-white/50 font-mono uppercase leading-relaxed">
          ...
          <div className="bg-deep-black p-8 border-r border-white/5 group hover:bg-neon-green/5 transition-colors">
            ...
            <h4 className="text-xl font-header font-black uppercase mb-4 tracking-tighter">Consensus Analysis</h4>
            <p className="text-[10px] text-white/50 font-mono uppercase leading-relaxed">
          ...
          <div className="bg-deep-black p-8 group hover:bg-neon-magenta/5 transition-colors border-l-2 border-neon-magenta">
            ...
            <h4 className="text-xl font-header font-black uppercase mb-4 tracking-tighter text-neon-magenta">Final Output</h4>
            <p className="text-[10px] text-white/50 font-mono uppercase leading-relaxed">
